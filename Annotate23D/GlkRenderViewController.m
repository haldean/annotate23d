...
@interface GlkRenderViewController () {
  GLuint _program;
...
@implementation GlkRenderViewController
...
- (void)setupGL {
  ...
  glBufferData(GL_ARRAY_BUFFER, _meshSize * 4 * 6, _mesh, GL_STATIC_DRAW);
...
#pragma mark - GLKView and GLKGlkRenderViewController delegate methods
...
- (BOOL)loadShaders {
  ...
  vertShaderPathname = [bundle pathForResource:@"Shader" ofType:@"vertex"];
  ...
  fragShaderPathname = [bundle pathForResource:@"Shader" ofType:@"fragment"];
